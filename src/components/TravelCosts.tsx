...
export function TravelCosts() {
    ...
    const costs: CostItem[] = [
        ...
        {
            category: 'Atrações',
            description: 'Jericoacoara (transporte)',
            quantity: 2,
            unitPrice: 141,
            icon: <Ticket className="w-5 h-5" />,
        },
        ...
        {
            category: 'Atrações',
            description: 'Taxa de reserva Ambiental de Jericoacoara',
            quantity: 2,
            unitPrice: 50,
            icon: <Ticket className="w-5 h-5" />,
        },
        ...
        {
            category: 'Estabelecimentos',
            description: 'Teatro José de Alencar (2 pessoas)',
            quantity: 2,
            unitPrice: 50,
            icon: <Ticket className="w-5 h-5" />,
        },
        {
            category: 'Estabelecimentos',
            description: 'Ronco do Mar (2 pessoas)',
            quantity: 2,
            unitPrice: 150,
            icon: <UtensilsCrossed className="w-5 h-5" />,
        },
