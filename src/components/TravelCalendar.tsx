...
const travelDays: TravelDay[] = [
    {
        ...
        activities: [
            ...
            'Check-in',
            'Noite: Passeio Beira Mar Fortaleza - Farmacia',
        ],
        highlight: 'travel',
        icon: 'plane',
    },
    ...
    },
    {
        ...
        activities: [
            ...
            'Tarde: Supermercado - Shopping Rio Mar Fortaleza - Johnny Joy, Gamestation, 4D Cinema, boliche',
    ...
    },
    {
        ...
        activities: [
            'Manha: Livre',
            'Tarde: Volei',
            'Noite: Luderia - Alugar jogos de tabuleiro (Wyrmspan, forest shufle, castle combo, its not a hat)',
        ],
